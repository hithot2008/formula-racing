...
await page.screenshot({ path: 'artifacts/test-runs/menu.png' });
...
await page.screenshot({ path: 'artifacts/test-runs/race.png' });
...
await page.screenshot({ path: 'artifacts/test-runs/results.png' });
await page.locator('#back').click();
...
await page.screenshot({ path: 'artifacts/test-runs/mobile-menu.png', fullPage: true });
